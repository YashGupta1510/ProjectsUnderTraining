	...
	<div class="fixed-header">
		...
		<div class="row">
			<div id="title" style="text-align: center;">
				<h1 style="background-color: DodgerBlue;">ADD BOOK</h1>
				...
				<form action="addBook" method="post">
					<div class="mb-3 row">
						<label for="BookCode" class="col-2 mx-4">Book Code</label> <input
							type="text" class="col-4" id="bookCode" placeholder="Book Code"
							name="bookCode" pattern="[A-Za-z0-9]+" required>
					</div>
					<div class="mb-3 row">
						<label for="BookName" class="col-2 mx-4">Book Name</label> <input
							type="text" class="col-4" id="bookName" placeholder="Book Name "
					...
					<div class="mb-3 row">
						<label for="AddedOn" class="col-2 mx-4">Added On</label> <input
							...
							value=" <%=calendar.getTime()%>" name="addedOn" readonly>
					</div>
