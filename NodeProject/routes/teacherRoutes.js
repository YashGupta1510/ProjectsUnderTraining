...
router.get(`/edit/:rollno`,teacherController.teacher_edit_get);
router.post('/edit/:rollno',teacherController.teacher_edit_post);
router.get('/delete/:rollno',teacherController.teacher_delete_get);
