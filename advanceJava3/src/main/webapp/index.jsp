...
<%@page import="com.nagarro.login.*"%>
<%@page import="com.nagarro.forget.*"%>
<%@page import="com.nagarro.hibernateUtil.FactoryProvider"%>
<%@page import="com.nagarro.product.*"%>
		...
		<div class="fixed-header">
			<div id="title" style="text-align: right;">
				...
				<form action="Logout" method="post">
					Hi <b><u><%=uname%></u> <input type="submit" value="Logout">
				</form>
			</div>
			<div id="title" style="text-align: center;">
				<h1 style="background-color: DodgerBlue;">Product Management
					Tool</h1>
			</div>
